require'neuron'.setup {
    ...
    neuron_dir = "~/Dropbox/Org", -- the directory of all of your notes, expanded by default (currently supports only one directory for notes, find a way to detect neuron.dhall to use any directory)
...
-- go to previous
vim.api.nvim_buf_set_keymap('0', 'n', 'gz[', "<cmd>lua require'neuron'.goto_prev_extmark()<CR>]]", {noremap = true})
